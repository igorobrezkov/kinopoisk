...
<template >
  ...
  <div class="film-detail__wrap" v-if="dataFilmDesc">
    <ul class="film-detail__list">
      <li
        class="film-detail__item"
        v-if="dataFilmDesc && dataFilmDesc.data?.language"
      >
        ...
        <span class="film-detail__desq">{{
          languageNames.of(dataFilmDesc.data?.language)
        }}</span>
      </li>
      <li
        class="film-detail__item"
        v-if="dataFilmDesc && dataFilmDesc.data?.budget"
      >
        <span class="film-detail__name"> Бюджет </span>
        <span class="film-detail__separaror"></span>
        <span class="film-detail__desq"
          >{{ getMoney(dataFilmDesc.data?.budget) }} {{ getCurrency() }}</span
        >
      </li>
      <li
        class="film-detail__item"
        v-if="dataFilmDesc && dataFilmDesc.data?.revenue"
      >
        <span class="film-detail__name"> Выручка </span>
        <span class="film-detail__separaror"></span>
        <span class="film-detail__desq"
          >{{ getMoney(dataFilmDesc.data?.revenue) }} {{ getCurrency() }}</span
        >
      </li>
      <li
        class="film-detail__item"
        v-if="dataFilmDesc && dataFilmDesc.data?.director"
      >
      ...
      <li
        class="film-detail__item"
        v-if="dataFilmDesc && dataFilmDesc.data?.production"
      >
        <span class="film-detail__name"> Продакшен </span>
        <span class="film-detail__separaror"></span>
        <span class="film-detail__desq">{{
          dataFilmDesc.data?.production
        }}</span>
      </li>
      <li
        class="film-detail__item"
        v-if="dataFilmDesc && dataFilmDesc.data?.awardsSummary"
      >
        <span class="film-detail__name"> Награды </span>
        <span class="film-detail__separaror"></span>
        <span class="film-detail__desq">{{
          dataFilmDesc.data?.awardsSummary
        }}</span>
      </li>
      <li
        class="film-detail__item"
        v-if="dataFilmDesc && dataFilmDesc.data?.homepage"
      >
        <span class="film-detail__name"> Домашняя страница </span>
        <span class="film-detail__separaror"></span>
        <a :href="dataFilmDesc.data?.homepage" :title="dataFilmDesc.data?.title"
          ><span class="film-detail__desq">
            {{ dataFilmDesc.data?.homepage }}</span
          ></a
        >
      </li>
    </ul>
