...
const validation = (): boolean => {
  ...
  if (
    ...
    !EmailValidator.validate(inputEmail.value)
  ) {
  ...
  if (
    inputPassConfirm.value.length > 0 &&
    inputPassConfirm.value.length < 6 &&
  ...
  if (
    ...
    inputPassConfirm.value !== inputPass.value &&
    isRegistration.value
  ) {
    ...
    <div class="modal__main">
      <div class="modal__content">
        ...
        <h3
          ...
          class="modal__registration modal__registration--title"
        >
          Регистрация <span v-show="registrationOk">завершена</span>
        </h3>
        <span class="modal__ok" v-show="registrationOk"
          >Используйте вашу электронную почту для входа</span
        >
        <form :class="{ modal__form: !registrationOk, none: registrationOk }">
          <input
            ...
            :class="{
              'modal__input--error': inputEmailError,
              'modal__email--error': inputEmailError,
            }"
            v-model="inputEmail"
          ...
          <input
            ...
            :class="{
              'modal__input--error': inputNameError,
              'modal__user--error': inputNameError,
            }"
            v-model="inputName"
            @input="clearValidInput"
          ...
          <input
            ...
            class="modal__input modal__input--user"
            :class="{
              'modal__input--error': inputLastNameError,
              'modal__user--error': inputLastNameError,
            }"
          ...
          <input
            ...
            :class="{
              'modal__input--error': inputPassError,
              'modal__pass--error': inputPassError,
            }"
            v-model="inputPass"
            @input="clearValidInput"
            v-if="!registrationOk"
          ...
          <input
            ...
            class="modal__input modal__input--pass"
            :class="{
              'modal__input--error': inputPassConfirmError,
              'modal__pass--error': inputPassConfirmError,
            }"
        ...
        <span
          v-if="!isRegistration"
          class="modal__registration modal__registration--name"
          @click="registration"
          >Регистрация</span
        >
        <span
